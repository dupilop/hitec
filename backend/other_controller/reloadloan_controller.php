...
<div class="modal fade" id="modalemioverview" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Loan Overview</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <table class="table table-bordered display table-hover table-sm" width="100%" cellspacing="0" id="example4" style="width:100%">

                    <thead style="background:red;color:white;">
                        <tr>
                            <th class="">#</th>
                            <th class="">Payment Deadline</th>
                            <th class="">Amount Collected</th>
                            <th class="">Target Collection</th>
                            <th class="">Status</th>
                            <th class=""></th>

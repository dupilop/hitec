...
INNER JOIN customers c ON l.l_c_id=c.c_id 
INNER JOIN admins a ON a.a_id=l.l_uploadedby WHERE l.l_uploadedby=:aid && l.l_status='paid' && l_upload_date_time LIKE :sdate
");
...
");
    ...
    ");
        ...
        $asd4 = $pdo->prepare("SELECT * FROM loans l
    INNER JOIN customers c ON l.l_c_id=c.c_id 
    INNER JOIN admins a ON a.a_id=l.l_uploadedby WHERE l.l_uploadedby=:aid && l.l_status='paid'
    ");

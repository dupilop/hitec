                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="col-md-1 col-sm-4" style="margin-top: 60%;">
                                        <a href="../images/customers/<?php echo $abc2['c_photo'] ?>" download class="btn btn-sm btn-outline-secondary"><i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="col-md-1 col-sm-4" style="margin-top: 60%;">
                                        <a href="../images/customers/<?php echo $abc2['c_front_citizenship'] ?>" downloads class="btn btn-sm btn-outline-secondary"><i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="col-md-1 col-sm-4" style="margin-top: 60%;">
                                        <a href="../images/customers/<?php echo $abc2['c_back_citizenship'] ?>" download class="btn btn-sm btn-outline-secondary"><i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-form-label col-md-6 col-sm-3 label-align">Check Sample
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <div class="col-md-11 col-sm-8">
                                        <input type="file" id="c_checkimage" class="dropify" name="c_checkimage" data-default-file="../images/customers/<?php echo $abc2['c_checkimage'] ?>" />
                                    </div>
                                    <div class="col-md-1 col-sm-4" style="margin-top: 60%;">
                                        <a href="../images/customers/<?php echo $abc2['c_checkimage'] ?>" download class="btn btn-sm btn-outline-secondary"><i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-form-label col-md-6 col-sm-3 label-align">Bank Statement
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <div class="col-md-11 col-sm-8">
                                        <input type="file" id="c_bankstatement" class="dropify" name="c_bankstatement" data-default-file="../images/customers/<?php echo $abc2['c_bankstatement'] ?>" />
                                    </div>
                                    <div class="col-md-1 col-sm-4" style="margin-top: 60%;">
                                        <a href="../images/customers/<?php echo $abc2['c_bankstatement'] ?>" download class="btn btn-sm btn-outline-secondary"><i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>

          ...
          <form class="" action="" method="post" id="form1" novalidate>
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="file" id="c_checkimage" class="dropify" name="c_checkimage" />
                </div>
              </div>
              <div class="form-group col-md-6">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="file" id="c_bankstatement" class="dropify" name="c_bankstatement" />
                </div>
              </div>
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                  <div class="col-md-12">
                    <label for="middle-name" class="col-form-label col-md-6 label-align">Credit Limit *</label>
                    <div class="col-md-6 col-sm-6">
    ...
    if (evalidation == true && climitvalidation == true && creatervalid == true && cnumvalidation == true && ccitizenvalidation == true && cnamevalidation == true && dobvalidation == true && ovalidation == true &&
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if(data.status){
            pb.clear();
            pb.success('<i class="fa fa-check-circle fa-lg" aria-hidden="true"></i> '+data.message);
          }else{
            pb.clear();
            pb.error('<i class="fa fa-exclamation-triangle fa-lg" aria-hidden="true"></i> '+data.message);
          }

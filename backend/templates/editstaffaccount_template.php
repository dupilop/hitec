 <?php
    ...
    echo '<form class="" action="" autocomplete="off"  id="form2" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                              <select class="form-control" name="ras_parent_id">';
    ...
    $rr->execute(['rname' => 'superadmin']);
    // $rrfet2 = $rr->fetchAll();
    $rrcount2 = $rr->rowCount();
    if ($rrcount2 > 0) {
        echo ' <optgroup label="Admins">';
        foreach ($rr as $adm22) {
            echo $adm22['ras_parent_id'];
            if ($a['ras_parent_id'] == $adm22['a_id']) {
                echo '<option selected value="' . $adm22['a_id'] . '">' . $adm22['a_fullname'] . '</option>';
            } else {

...
if ($per->permit('p_addadminaccount', $pdo)) {
?>
                    ...
                    <div class="x_content">
                        <form class="" action="" method="post" id="form1" novalidate>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="a_position" class='optional' name="a_position" data-validate-length-range="5,15" type="text" />
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="a_mobile" type="number" class='number' name="a_mobile" data-validate-minmax="1000000000,10000000000" required='required'>
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="a_phone" type="number" class='number' name="a_phone" data-validate-minmax="1000000000,10000000000" required='required'>
                                </div>
                            ...
                            <div class="ln_solid">
                                <div class="form-group">
                                    <div class="col-md-6 offset-md-3">
                                        <button type='submit' id="addadmin" name="add" class="btn btn-primary add">Add</button>
...
<script type="text/javascript">
    ...
    function load_data() {
        ...
        $.ajax({
            url: "other_controller/viewadminaccount.php",
            method: "POST",
    ...
    $(document).on('submit', '#form1', function(e) {
        ...
        if (fvalidation == true && dvalidation == true && povalidation == true && mvalidation == true && phvalidation == true && gvalidation == true &&
            ...
            $.ajax({
                type: "POST",
                url: "other_controller/addadmin.php",
        ...
        pb.confirm(
            function(outcome) {
                if (outcome) {
                    $.ajax({
                        type: "GET",
                        url: "other_controller/deleteadmin.php?did=" + id,
                        data: data,
                        contentType: false,
                        processData: false,
                        success: function(data) {
    ...
    //   $.ajax({
    //                   type: "POST",
    //                   url: "other_controller/updateadmin.php?a_id="+id,

 <?php
    require './../config.php';
    echo '<form class="" action="" autocomplete="off" enctype="multipart/form-data"  id="form2" method="post" novalidate>
                                       
                                        <span class="section">Stock Update</span>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class="number" value="' . $a['st_price'] . '" name="st_price" data-validate-length-range="2,15" required="required" type="text" /></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Quantity<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class="number" value="' . $a['st_qty'] . '" name="st_qty" data-validate-length-range="1,15" required="required" type="text" /></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Image<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control dropify" class="number" data-default-file="' . $baseapiurl . 'images/stocks/' . $a['st_image'] . '" value="' . $a['st_image'] . '" name="st_image" type="file" /></div>
                                        </div>
                                        <div class="field item form-group">

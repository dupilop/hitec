        ...
        var table2 = $('#example').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        var total = parseFloat(data.loanamount) - parseFloat(data.downpayment) + parseFloat(data.servicecharge);
                        return total;
                    }
                },
                {
                    "data": "l_id",
                    render: function(data) {
                        return '<a href="editloan?lid=' + data + '" class="btn btn-sm btn-outline-primary">Edit</a><a href="viewloan?lid=' + data + '" class="btn btn-sm btn-outline-primary">View</a>';
                    }
                }
            ],
            lengthMenu: [

            ...
            if (tokenverify($data1['a_token'])) {
                if (isset($_POST['c_citizenship_number'])) {
                    ...
                    if ($rcheck > 0) {
                        ...
                        $send_res = sendmessage('3b83171c6652431626034ba629539855a8edb93d49b058738367a07956978dda', $_POST['c_mobile'], "Thank you for registering to Hitec Vision Pvt Ltd.");

...
$cusers = $pdo->prepare("SELECT * FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id  WHERE s.s_id='$userid'");
$cusers->execute();
...
$cusers2 = $pdo->prepare("SELECT * FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id  WHERE s.s_id='$userid' && c.c_gender='Male'");
$cusers2->execute();
...
$cusers3 = $pdo->prepare("SELECT * FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id  WHERE s.s_id='$userid' && c.c_gender='Female'");
$cusers3->execute();
...
$cusers33 = $pdo->prepare("SELECT * FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id  WHERE s.s_id='$userid' && c.c_gender='Others'");
$cusers33->execute();
...
$cusers4 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, ms.ms_id, ms.ms_amount FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id 
                    INNER JOIN masiksavings ms ON ms.c_id=c.c_id WHERE s.s_id='$userid'");
$cusers4->execute();
...
$cusers44 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, lt.lt_id, lt.lt_uploaddate, lt.lt_grand_total FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id 
                    INNER JOIN loan_transactions lt ON lt.c_id=c.c_id WHERE s.s_id='$userid'");
$cusers44->execute();
...
$cusers5 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, ms.ms_id, ms.ms_amount FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id
                    INNER JOIN masiksavings ms ON ms.c_id=c.c_id WHERE s.s_id='$userid' && ms.ms_dateupload LIKE '%$today%'");
$cusers5->execute();
...
$cusers55 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, lt.lt_id, lt.lt_uploaddate, lt.lt_grand_total FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id 
                    INNER JOIN loan_transactions lt ON lt.c_id=c.c_id WHERE s.s_id='$userid' && lt.lt_uploaddate LIKE '%$today%'");
$cusers55->execute();
...
$ycusers5 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, ms.ms_id, ms.ms_amount FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id
                    INNER JOIN masiksavings ms ON ms.c_id=c.c_id WHERE s.s_id='$userid' && ms.ms_dateupload LIKE '%$yesterday%'");
$ycusers5->execute();
...
$ycusers55 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, lt.lt_id, lt.lt_uploaddate, lt.lt_grand_total FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id 
                    INNER JOIN loan_transactions lt ON lt.c_id=c.c_id WHERE s.s_id='$userid' && lt.lt_uploaddate LIKE '%$yesterday%'");
$ycusers55->execute();
...
$ycusers6 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, ms.ms_id, ms.ms_amount FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id 
                    INNER JOIN masiksavings ms ON ms.c_id=c.c_id WHERE s.s_id='$userid' && ms.ms_dateupload LIKE '%$twodayago%'");
$ycusers6->execute();
...
$ycusers66 = $pdo->prepare("SELECT c.c_id, c.c_name, s.s_id, s.s_fullname, lt.lt_id, lt.lt_uploaddate, lt.lt_grand_total FROM customers c 
                    LEFT JOIN staffs s ON c.c_created_by=s.s_id
                    INNER JOIN loan_transactions lt ON lt.c_id=c.c_id WHERE s.s_id='$userid' && lt.lt_uploaddate LIKE '%$twodayago%'");
$ycusers66->execute();

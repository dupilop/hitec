...
$userid2 = $_SESSION['id'];
$sql2 = "SELECT * FROM staffs WHERE s_id='$userid2'";
$abc2 = $pdo->prepare($sql2);
$abc2->execute();
$dat2 = $abc2->fetch();

$dat3 = $pdo->query("SELECT * FROM notifications WHERE n_receiver='all' || n_receiver='staff'");
?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3  profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          if($dat2['s_profile_image'] == ''){
                            ...
                            echo '<img class="img-responsive avatar-view" src="../../images/profile/'.$dat2['s_profile_image'].'" width="100px" height="100px" alt="Avatar" title="Change the avatar" style="border-radius: 50%;">';
                          }
                      ...
                      <h3><?php  echo $dat2['s_fullname']; ?></h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> <?php  echo $dat2['s_address']; ?>
                        </li>

                        <li>
                          <i class="fa fa-building" aria-hidden="true"></i> <?php  echo $dat2['s_department'];  ?>
                        </li>
                        <li>
                          <i class="fa fa-envelope-o" aria-hidden="true"></i> <?php  echo $dat2['s_email']; ?>
                        </li>
                        <li>
                          <span class="badge badge-danger"><i class="fa fa-user" aria-hidden="true"></i> <?php  echo $dat2['s_position'];  ?></span>
                        </li>
                      </ul>
                    ...
                    ?>
                              <li>
                                ...
                                <div class="message_wrapper">
                                  <h4 class="heading"><span class="badge badge-danger"><i class="fa fa-send"></i> <?php echo $vv['n_receiver'];  ?></span></h4>
                                  <blockquote class="message"><i class="fa fa-inbox"></i> <?php echo $vv['n_text']; ?></blockquote>
                                  <br />
                                  <p class="url">

...
$userid = $_SESSION['id'];
$sql = "SELECT * FROM staffs WHERE s_id='$userid'";
$abc = $pdo->prepare($sql);
$abc->execute();
$dat = $abc->fetch();
?>
...
<html lang="en">
  ...
  <link rel="icon" href="../../images/logo/hitechvision.jpg" type="image/ico" />
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Invoice<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="masiksavings">Savings</a></li>
      ...
      document.body.requestFullscreen();
        ...
        <div class="top_nav">
          <div class="nav_menu">
              ...
              <span style="color:#46ae53;margin-left: -50px;font-size: 15px;">HITECH VISION PVT. LTD.       |        </span>
               ...
               echo date("Y-m-d h:i:sa");  ?></span>
                ...
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <?php 
                    if($dat['s_profile_image'] != ''){
                      echo '<img src="../../images/profile/'.$dat['s_profile_image'].'" alt="">'.$dat['s_position'];
                  }else{
                    echo '<img src="../../images/noimage.jpg" alt="">'.$dat['s_position'];
                  }
                  ?>

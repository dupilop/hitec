          ...
          <div class="card-body" style="color:white;">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                ...
                <?php echo 'Rs. ' . $dat2['c_total_saving_amount']; ?><br>
                <?php echo date('Y-m-d', strtotime($dat2['l_upload_date_time'])); ?><br>
                <?php echo date('h:i:sa', strtotime($dat2['l_upload_date_time'])); ?><br>
              </div>
            </div>
          </div>
            ...
            <div class="row no-gutters align-items-center">
              <form action="loanpayment" method="POST">
                <div class="col mr-2 form-group row">
                  ...
                  <div class="col-sm-5">
                    <input type="text" readonly class="form-control-plaintext" id="total_amount" value="<?php echo $dat2['l_amount']; ?>" style="width: 100%;">
                  </div>
                </div>
                <div class="col mr-2 form-group row">
                  <label for="total_amount" class="col-lg-7 col-form-label"><b>Remaining Payments (in Rs):</b></label>
                  <div class="col-sm-5">
                    <input type="text" readonly class="form-control-plaintext" id="total_remaining_amount" value="<?php echo $dat2['l_remaining_loan']; ?>" style="width: 100%;">
                    <input type="text" readonly class="form-control-plaintext" id="total_new_remaining_amount" name="total_new_remaining_amount" value="<?php echo $dat2['l_remaining_loan']; ?>" style="width: 100%;color:red;">
                  </div>
                </div>
                <div class="col mr-2 form-group row">
                ...
                <div class="col mr-2 form-group row">
                  ...
                  <div class="col-sm-5">
                    ...
                    ?>
                    <input type="number" name="lt_penalty" id="penalty_amount" value="<?php echo round($penalty, 2); ?>" class="form-control-plaintext" style="width: 100%;" required>
                  </div>
                </div>
                <div class="col mr-2 form-group row">

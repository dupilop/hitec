...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        finish  : $('<a href="#" onclick="document.getElementById("form1").submit();">'+options.labelFinish+'</a>').addClass("buttonFinish")
    };
    ...
    var _init = function($this) {
        ...
        $($this.buttons.finish).click(function(e) {
            ...
            if(!$(this).hasClass('buttonDisabled')){
                ...
                if(evalidation == true && cnumvalidation == true && cnamevalidation == true && dobvalidation == true && ovalidation == true 

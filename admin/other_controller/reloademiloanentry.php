...
$asd = $pdo->query("SELECT * FROM customers c 
                    LEFT JOIN loans l ON c.c_id=l.l_c_id LEFT JOIN staffs s ON c.c_created_by=s.s_id || c.c_created_by=s.s_a_id
                  WHERE s.s_a_id='$userid' || c.c_created_by='$userid'");
                    ...
                    <div class="modal fade bs-example-modal-sm" id="mod' . $a['c_id'] . '" data-backdrop="" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <form class="" action="" method="post" novalidate>
                        ...
                        <div class="modal-body">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Loan Amount<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Down Payment<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                        ...
                        <input type="hidden" name="l_c_id" class="l_c_id" value="' . $a['c_id'] . '">

 ...
 echo '<form class="" action="" autocomplete="off"  id="form2" method="post" novalidate>
                                        ...
                                        <span class="section">Edit Stock</span>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Description<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="1" name="st_desc" required="required" value="'.$a['st_desc'].'" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class="number" value="'.$a['st_price'].'" name="st_price" data-validate-length-range="1,15" required="required" type="text" /></div>
                                        </div>
                                        <div class="field item form-group">

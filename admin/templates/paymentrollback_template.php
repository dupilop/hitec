  ...
  <script type="text/javascript">
    ...
    <input type="hidden" id="dat" value="">        
              ...
              echo '<p style="text-align:center; caption-side:top; color:#013220; font-family:verdana;font-size:20px;"> <b style="font-size:24px; color:red;" id="couu"></b></p>';
                  ...
                  <thead class="thead-dark">
                    ...
                    <tbody>
                      ...
                      foreach ($asd as $a) {
                        ...
                        echo '<td><button class="btn btn-sm btn-danger remloan" id="'.$a['lt_id'].'"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button></td>';
                        echo '</tr>';
                        }
                        ?>
                ...
                <script type="text/javascript">
    $(document).on("click", ".remloan", function(e){
      var id = $(this).attr('id');
      var data = 'cbid=' + id;
      e.preventDefault();
      pb.confirm(
          function (outcome) {
           if(outcome){
            $.ajax({
                      type: "GET",
                      url: "../other_controller/cancelemibill.php?cbid="+id,
                      data: data,
                      contentType: false,
                      processData: false,
                      beforeSend: function(){

...
$dat3 = $pdo->query("SELECT * FROM notifications WHERE n_receiver='all' || n_receiver='admin'");
?>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3  profile_left">
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li>
                          <span class="badge badge-danger"><i class="fa fa-user" aria-hidden="true"></i> <?php  echo $dat2['a_position'];  ?></span>
                        </li>
                      </ul>

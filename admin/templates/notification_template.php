                                    ...
                                    <form class="" action="" method="post" id="form1" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="n_text" id="n_text" required="required" />
                                                <input type="hidden" readonly name="u_type" value="admin">
                                                <input type="hidden" readonly name="n_status" value="new">
                                                <input type="hidden" readonly name="u_id" value="<?php  echo $userid;  ?>">
                                            </div>
...
<script>
  ...
  $(document).on('submit', '#form1', function(e){
    ...
    if($.trim(n_text) == ''){
        $(".txterror").html("<p class='text text-danger'>Empty Notification cannot be pushed</p>"); 
    }else{
    $.ajax({
                    type: "POST",

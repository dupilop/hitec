                            ...
                            <div class="x_panel">
                                ...
                                <form class="" action="" method="post" id="form1" novalidate>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_dob" class='date' type="date" name="s_dob" required='required'></div>
                                             <div class="s_dob"></div>
                                         </div>
                                     <div class="field item form-group">
                                         <label class="col-form-label col-md-3 col-sm-3  label-align">Position<span class="required">*</span></label>
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_position" class='optional' name="s_position" type="text" /></div>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_mobile" type="number" class='number' name="s_mobile"  required='required'></div>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_phone" type="number" class='number' name="s_phone"  required='required'></div>
                                             <div class="s_phone"></div>
                                         </div>
                                     <div class="field item form-group">
                                         <label class="col-form-label col-md-3 col-sm-3  label-align">Gender <span class="required">*</span></label>
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_gender" type="text" class='number' name="s_gender"></div>
                                             <div class="s_gender"></div>
                                         </div>
                                     <div class="field item form-group">
                                         <label class="col-form-label col-md-3 col-sm-3  label-align">Address<span class="required">*</span></label>
                                         <div class="col-md-6 col-sm-6">
                                             <textarea required="required" id="s_address" name='s_address'></textarea></div>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                         <input type="text" readonly value="<?php echo $dat['a_fullname'];  ?>" class="form-control-plaintext">
                                              <input type="hidden" readonly name="s_a_id" value="<?php echo $dat['a_id'];  ?>" class="form-control">
                                             </div>
                                     </div>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="s_email" name="s_email"  class='email' required="required" type="email" /></div>
                                     ...
                                     <div class="field item form-group">
                                         ...
                                         <div class="col-md-6 col-sm-6">
                                             <input class="form-control" id="cpassword" type="password" data-validate-linked='password' required='required' /></div>
    ...
    $.ajax({
                    ...
                    success: function(data) {
                       $("#form1")[0].reset();
                        load_data();
                        pb.clear();
                        pb.success('<i class="fa fa-check-circle fa-lg" aria-hidden="true"></i> Staff Added Successfully');
                    }
                });
            }else{
                pb.clear();
